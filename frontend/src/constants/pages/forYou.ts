...
export const FOR_YOU_CAREER_PATHS = [
...
export const FOR_YOU_EXPERIENCE_OPTIONS = [
...
export const FOR_YOU_WORK_MODE_OPTIONS = ['Any work mode', 'Remote', 'Hybrid', 'On-site'] as const;

/** @deprecated Use FOR_YOU_WORK_MODE_OPTIONS + getCountryOptions() instead. */
export const FOR_YOU_LOCATION_OPTIONS = [
  'Any location',
  ...FOR_YOU_WORK_MODE_OPTIONS.slice(1),
  'India',
  'United States',
  'Europe',
] as const;
