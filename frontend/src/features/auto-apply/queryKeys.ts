export const autoApplyQueryKeys = {
  ...
  workspace: (jobApplicationId: string) => ['auto-apply', 'workspace', jobApplicationId] as const,
  ...
  readiness: (jobId: string, stage: string) => ['auto-apply', 'readiness', jobId, stage] as const,
