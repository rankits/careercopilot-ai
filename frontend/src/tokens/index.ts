...
export const colorTokens = {
  ...
  dialogGlow: palette.blue500,
  dialogGlowSubtle: palette.blue100,
  dialogEnvelopeHighlight: palette.blue600,
  ...
  note: {
    ...
    offer: { accent: palette.orange500, background: palette.gray100, color: palette.gray700 },
    preparation: { accent: palette.blue700, background: palette.blue100, color: palette.blue800 },
    recruiter: { accent: palette.green600, background: palette.green50, color: palette.green700 },
