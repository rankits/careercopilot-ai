      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              border: 'none',
              background: mode === 'dock-left' ? 'white' : 'transparent',
              padding: '4px 8px',
              borderRadius: '4px',
              fontSize: '12px',
              fontWeight: 500,
              color: mode === 'dock-left' ? '#2563eb' : '#6b7280',
              boxShadow: mode === 'dock-left' ? '0 1px 2px rgba(0,0,0,0.05)' : 'none',
              cursor: 'pointer',
            }}
          >
            Left
          ...
          <button
            ...
            style={{
              border: 'none',
              background: mode === 'dock-right' ? 'white' : 'transparent',
              padding: '4px 8px',
              borderRadius: '4px',
              fontSize: '12px',
              fontWeight: 500,
              color: mode === 'dock-right' ? '#2563eb' : '#6b7280',
              boxShadow: mode === 'dock-right' ? '0 1px 2px rgba(0,0,0,0.05)' : 'none',
              cursor: 'pointer',
            }}
          >
            Right
