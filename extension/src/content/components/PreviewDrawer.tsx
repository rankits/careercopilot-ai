...
export const PreviewDrawer: React.FC<PreviewDrawerProps> = ({ fields, answers, vaultKeys = {}, contentGenerationAllowed = false, onConfirm, onCancel }) => {
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '16px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <div style={{ display: 'flex', background: '#f3f4f6', borderRadius: '6px', padding: '2px' }}>
            <button style={{ border: 'none', background: 'white', padding: '4px 8px', borderRadius: '4px', fontSize: '12px', fontWeight: 500, color: '#2563eb', boxShadow: '0 1px 2px rgba(0,0,0,0.05)', cursor: 'pointer' }}>Auto</button>
            <button style={{ border: 'none', background: 'transparent', padding: '4px 8px', fontSize: '12px', fontWeight: 500, color: '#6b7280', cursor: 'pointer' }}>Left</button>
            <button style={{ border: 'none', background: 'transparent', padding: '4px 8px', fontSize: '12px', fontWeight: 500, color: '#6b7280', cursor: 'pointer' }}>Right</button>
          </div>
          <button onClick={onCancel} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#6b7280', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ padding: '8px 20px', borderTop: '1px solid #f3f4f6', borderBottom: '1px solid #f3f4f6', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '12px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              return (
                <div key={f.identifier} style={{ display: 'flex', alignItems: 'flex-start', padding: '12px 0', borderBottom: i === displayFields.length - 1 ? 'none' : '1px solid #f3f4f6', opacity: f.isSensitive ? 0.6 : 1 }}>
                  ...
                  <div style={{ paddingTop: '8px', paddingRight: '12px' }}>
                    <div 
                      onClick={() => !f.isSensitive && !isMissingVault && handleToggle(f.identifier)}
                      style={{ 
      ...
      {/* Footer */}
      <div style={{ padding: '16px 20px', borderTop: '1px solid #f3f4f6', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#ffffff', borderRadius: '0 0 12px 12px' }}>
      ...
      <div style={{ position: 'absolute', bottom: '4px', right: '4px', width: '12px', height: '12px', opacity: 0.2 }}>
        <svg viewBox="0 0 12 12"><path d="M10,0 L12,0 L12,12 L0,12 L0,10 L10,10 L10,0 Z M5,5 L7,5 L7,12 L5,12 L5,5 Z M0,5 L2,5 L2,12 L0,12 L0,5 Z" fill="currentColor"/></svg>
      </div>
    </div>
  );
};
