...
describe('sensitiveFieldTreatment', () => {
  it('does not render a checkbox for sensitive fields and shows proper text', () => {
    ...
    const fields = [
      { identifier: 'normal_field', tagName: 'input', type: 'text', label: 'First Name', isSensitive: false },
      { identifier: 'sensitive_field', tagName: 'select', type: 'select-one', label: 'Race/Ethnicity', isSensitive: true },
    ];
