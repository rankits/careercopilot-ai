...
import type { FakeDb as FakeDbType } from "@/test-utils/fake-prisma.js";
 ...
 */
vi.mock("@/shared/config/db.conf.js", async () => {
  const { FakeDb } = await import("@/test-utils/fake-prisma.js");
