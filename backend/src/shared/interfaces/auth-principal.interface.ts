 ...
 * internal sequential db id. `tokenVersion` is compared against the
 * principal's current `tokenVersion` so tokens issued before a
 * password change/reset/logout-all are rejected immediately.
 */
