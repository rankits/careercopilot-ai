...
describe('JobAgePolicy', () => {
  it('uses day-based cutoffs', () => {
    ...
    expect(policy.getStorageCutoffDate()).toEqual(new Date('2026-05-05T00:00:00.000Z'));
    expect(policy.getEmbeddingCutoffDate()).toEqual(new Date('2026-07-29T00:00:00.000Z'));
  });
  ...
  it('evaluates storage eligibility independently of embedding settings', () => {
    ...
    expect(
      policy.evaluateStorageEligibility({
        effectiveDate: new Date('2026-05-04T23:59:59.000Z'),
      }).reason,
