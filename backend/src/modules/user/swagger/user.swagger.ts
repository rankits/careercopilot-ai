        ...
        config: {
          ...
          responses: {
            200: {
              ...
              schema: successSchema('Profile fetched', safeUserSchema),
            },
            ...commonSecureResponses,
          },
        },
        ...
        config: {
          ...
          responses: {
            200: {
              ...
              schema: successSchema('Profile updated', safeUserSchema),
            },
            400: {
    ...
    BASE_URL,
    {
      ...
      queryParams: [
        ...
        },
        {
          ...
          in: 'query',
          schema: { type: 'string' },
          description: 'Matches email, first name, or last name (case-insensitive)',
        },
      ],
      responses: {
        200: {
